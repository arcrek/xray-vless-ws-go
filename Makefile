...
# All platforms the Python PoC supported, minus android/arm64 (see note in
# go/README.md — a transitive dependency currently fails to link on that
# target with CGO_ENABLED=0; tracked as a known limitation, not silently
# dropped).
