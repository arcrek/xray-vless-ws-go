...
// WriteNamedTunnelConfig writes config.yml for the named-tunnel path. Named
// tunnels dial out using this file plus TUNNEL_TOKEN embedded as the
// `tunnel:` field — no hostname is ever scraped from logs for this path
