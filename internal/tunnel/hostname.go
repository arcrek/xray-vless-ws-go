...
// StripANSI removes ANSI color/cursor escape codes, ported from main.py:310.
// Verified against a real captured cloudflared run (testdata/quicktunnel_stdout.txt)
...
// the quick-tunnel hostname. Unlike main.py's single global regex search
