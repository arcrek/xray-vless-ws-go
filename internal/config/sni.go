...
// ParseSNIList parses the FAKE_SNI env var. Each comma-separated entry may
// carry a "#remark" suffix; a bare entry (or an entry with an empty remark
// after "#") gets a default "Tunnel N" remark.
