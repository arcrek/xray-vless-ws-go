...
This is the Go repo's own embedded copy (see internal/cfdeploy), kept
functionally identical to xray_vless_ws_server/_worker.js so the two repos
stay decoupled per the parent rebuild plan's decision #9 — the Python repo's
file is not read at runtime. The password line's literal is a template
marker (__WORKER_PASSWORD__), substituted by deploy.go before upload; do not
hand-edit it into a real password here.
