// Package cfdeploy automates deploying the Cloudflare Worker bridge (the
// script deploy + Workers KV binding steps) via the Cloudflare REST API,
// given CLOUDFLARE_API_TOKEN + DOMAIN
